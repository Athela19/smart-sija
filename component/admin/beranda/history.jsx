...
export default function History() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white border border-gray-200 rounded-xl min-h-screen">
      <h1 className="text-xl font-bold mb-4">Riwayat Aktivitas</h1>
      ...
      <div className="space-y-2">
        {riwayat.map(({ id, aksi, createdAt, user }) => (
          <div
            key={id}
